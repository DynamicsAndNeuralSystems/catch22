...
For _catch22_-related information and resources, including a list of publications using _catch22_, see the [_catch22_ wiki](https://github.com/chlubba/catch22/wiki).
